...
<CLIPDeclarationSet>
   ...
   <Value>/Connector0/DIO6</Value>
				...
				<Item Name="WA chopper" Type="Elemental IO">
					<Property Name="eioAttrBag" Type="Xml"><AttributeSet name="FPGA Target">
   <Attribute name="ArbitrationForOutputData">
   <Value>NeverArbitrate</Value>
   </Attribute>
